...
- Online: OpenAI Chat Completions with structured schema; references valid entities (E*, R*, A*, D*).
- Offline / Fallback: Rule-based heuristics for deterministic offline response.
"""
...
def answer(question: str, S: dict[str, Any], layout: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        if r:
            return r
    except Exception as e:  # Fallback to rule-based analysis on API error
