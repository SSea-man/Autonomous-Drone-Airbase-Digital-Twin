"""What-if simulation deterministic branching and scenario delta verification."""
import json
...
def test_clone_is_deterministic_and_independent():
    ...
    assert json.dumps(e.state, sort_keys=True) == snap           # Live state unchanged
...
def test_whatif_compound_scenario_hurts_task_time():
    ...
    # Task burst introduces additional volume; core metric is avg task duration
